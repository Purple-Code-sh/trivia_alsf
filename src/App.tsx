      ...
      {hasStarted ? (
        ...
        <section className=' w-screen relative overflow-hidden min-h-[100vh] flex flex-col items-center justify-center'>
          ...
          <div className='container flex flex-col lg:flex-row py-6 mx-auto gap-0'>
            <div className='w-full lg:w-1/2 flex flex-col justify-center items-center lg:items-start gap-8 sm:gap-12'>
              <h1 className='text-secondary mb-2 lg:mb-4 xl:mb-6 text-center leading-16 md:leading-20 lg:leading-24 2xl:leading-32 lg:text-left font-playwrite font-bold text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl'>
                Aprendizaje <span className='text-accent-orange'>Experiencial</span>
              </h1>
              ...
              <h2 className='max-w-[420px] text-center lg:text-left md:max-w-[500px] lg:max-w-[600px] text-base md:text-lg xl:text-xl self-center lg:self-start'>
                Este es un cuestionario en el que pones a prueba tus conocimientos sobre el aprendizaje experiencial.<br /> Tomalo con calma y no te preocupes por las respuestas correctas o incorrectas. Solo diviertete 😄
              </h2>
